...
registerPage('contest_detail_problem_submit', () => import('./problem_submit'));
registerPage('homework_detail_problem_submit', () => import('./problem_submit'));
registerPage('record_main', () => import('./record_main'));
registerPage('record_detail', () => import('./record_detail'));
registerPage('code_replay', () => import('./code_replay'));
registerPage('contest_main', () => import('./contest_main'));
registerPage('contest_detail', () => import('./contest_detail'));
registerPage('contest_problemlist', () => import('./contest_detail'));
registerPage('contest_create', () => import('./contest_edit'));
registerPage('contest_scoreboard', () => import('./contest_scoreboard'));
registerPage('homework_scoreboard', () => import('./contest_scoreboard'));
...
registerPage('contest_detail_problem_hack', () => import('./problem_hack'));
...
registerPage('training_create', () => import('./training_edit'));
